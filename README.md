...
| Testing        | Vitest (117 unit tests), Playwright (E2E smoke), offline eval script                                   |                                                                                                                     |
...
| `npm test`                                              | 117 unit tests (chunking, parsing, BM25, fusion, query expansion, retrieval, confidence, citations and verification, analysis rules, JD scoring, LLM providers and streaming, API validation) |
