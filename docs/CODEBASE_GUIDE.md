...
| Folder       | Contents                                                                                                                                                                                                                                                                                                        |
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `app-shell/` | `app-sidebar.tsx` (primary items, "More tools", collapsible "Under the hood"), `topbar.tsx` (model download pill, LLM status pill, theme toggle), `activity-bar.tsx` (progress under the header for model downloads and indexing), `nav.ts`, `rag-bridge.tsx` (syncs settings to the worker, pre-loads models). |
...
| `common/`    | `page-header.tsx`, `page-skeleton.tsx` (loading placeholders), `doc-type.tsx`, `score-bar.tsx` (meters and rings), `confidence-badge.tsx`, `markdown.tsx` (safe rendering), `cited-text.tsx`, `feature-states.tsx` (empty/LLM notices), `severity.tsx`.                                                         |
...
| `/dashboard`                                                                                   | `(app)/dashboard/page.tsx`              | Home: three steps, the two primary actions, next step, tools; `?demo=1` loads the demo. |
| `/documents`                                                                                   | `(app)/documents/page.tsx`              | Knowledge base.                                                                         |
| `/ask`                                                                                         | `(app)/ask/page.tsx`                    | Chat with evidence panel, history, scope selector.                                      |
| `/prep`, `/prep/resume`, `/prep/project`, `/prep/questions`, `/prep/star`, `/prep/consistency` | `(app)/prep/**`                         | Prep tools.                                                                             |
| `/mock`                                                                                        | `(app)/mock/page.tsx`                   | Mock interview.                                                                         |
| `/jd`                                                                                          | `(app)/jd/page.tsx`                     | Job match.                                                                              |
...
| —                                                                                              | `(app)/layout.tsx`                      | Sidebar shell, top bar and activity bar for all app pages.                              |
| —                                                                                              | `(app)/loading.tsx`, `(app)/error.tsx`  | Route-level skeleton and error boundary.                                                |
