...
| Testing        | Vitest (119 unit tests), Playwright (E2E smoke), offline eval script                                   |                                                                                                                     |
...
| `npm test`                                              | 119 unit tests (chunking, parsing, BM25, fusion, query expansion, retrieval, confidence, citations and verification, analysis rules, JD scoring, LLM providers and streaming, API validation) |
